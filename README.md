...
| `feat/design-refresh`      | Sharp/zero-radius design direction, legacy catalogue import, archive view, made-to-order page with reference photos, motion pass, concurrency hardening, test coverage pass (this branch) | Pushed, ahead of `origin` locally                                   |
| `feat/reviews`             | Product/event/order/booking reviews, optimistic in React                                                                                                                                  | Rebased on the tip of `feat/design-refresh` locally, not yet pushed |
| `feat/admin`               | Admin dashboard, catalogue/order/event/workshop/coupon/content/user management                                                                                                            | Rebased on the tip of `feat/reviews` locally, not yet pushed        |
| `feat/admin-ui`            | Admin console shell, tables and forms for every `feat/admin` module                                                                                                                       | Rebased on the tip of `feat/admin` locally, not yet pushed          |
