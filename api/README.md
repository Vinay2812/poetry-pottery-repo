...
| glazes                     | `adminGlazes`                                                                                                                              | `createGlaze`, `updateGlaze`, `deleteGlaze`                                                                                                                                                                                                                                       |
...
| inbox                      | `adminContactMessages`, `adminNewsletterSubscribers`, `exportNewsletterSubscribers`, `adminBatchNotifications`, `exportBatchNotifications` | `setContactMessageRead`, `deleteContactMessage`, `unsubscribeSubscriber`                                                                                                                                                                                                          |
| commissions                | `commissionRequests`                                                                                                                       | `markCommissionRequestRead`, `setCommissionRequestStatus`                                                                                                                                                                                                                         |
| visits                     | `adminStudioVisits`                                                                                                                        | `cancelStudioVisit`                                                                                                                                                                                                                                                               |
