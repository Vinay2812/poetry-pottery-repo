...
import { coupons, events } from "./content";

// Optional demo catalogue for local development: `pnpm db:seed:demo`. Real data comes from `pnpm import:legacy`.
...
async function main(): Promise<void> {
  ...
  process.stdout.write(
    `Seeded ${products.length} demo products, ${events.length} events, ${coupons.length} coupons\n`,
  );
}
